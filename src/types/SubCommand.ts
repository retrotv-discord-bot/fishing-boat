...
export default class SubCommand {
     ...
     */
    setAutocomplete(autocompleteFunction: (interaction: AutocompleteInteraction) => Promise<void> | void): void {
     ...
     */
    setExecute(executeFunction: (interaction: ChatInputCommandInteraction) => Promise<void> | void): void {
